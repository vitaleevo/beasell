          ...
          <div className="relative">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl bg-gray-100 flex items-center justify-center">
              <div className="text-center">
                <Play className="h-16 w-16 text-[#F39200] mx-auto mb-4" />
                <p className="text-gray-600">Vídeo em breve</p>
              </div>
            </div>
            <div className="absolute -bottom-4 -right-4 bg-[#F39200] text-white p-4 rounded-xl shadow-xl">
            ...
            <div className="space-y-4">
              {features.map((item, index) => (
                <div key={index} className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-[#F39200] flex-shrink-0" />
                  <span className="text-gray-700">{item}</span>
                </div>
              ))}
            </div>

            <Button size="lg" className="bg-[#F39200] hover:bg-[#d68000] text-white">
