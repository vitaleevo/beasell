...
const BlogFilters = ({
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-xl border-none">
      ...
      <div className="space-y-4">
        <div>
          ...
          <Select value={selectedCategory} onValueChange={onCategoryChange}>
            <SelectTrigger className="border-none bg-gray-50 rounded-xl focus:ring-2 focus:ring-[#F39200]/20">
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Ano</label>
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Tempo de Leitura</label>
