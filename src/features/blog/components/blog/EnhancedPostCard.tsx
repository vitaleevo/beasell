    ...
    <Card className={`group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 overflow-hidden bg-white ${isFeatured ? 'ring-2 ring-orange-200 shadow-lg' : 'shadow-md'
      ...
      {!isLarge && (
        <div className="p-6">
          ...
          {isCompact && (
            <Badge variant="secondary" className="mb-3 bg-blue-50 text-blue-700 border-none">
              {post.category}
            </Badge>
          )}
          ...
          <Link href={`/conteudos/${post.slug}`}>
            <Button
              ...
              className="w-full group/btn bg-gray-50 border-none hover:bg-blue-900 hover:text-white transition-all duration-300 shadow-sm"
            >
              Ler Artigo
