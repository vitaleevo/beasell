...
function BlogPageContent() {
    ...
    const initialSearchQuery = searchParams.get("pesquisa") ?? searchParams.get("q") ?? "";
    ...
    const categories = useMemo(() => {
        ...
        return rawCategories.map(cat => ({
            ...
            name: cat.name,
            slug: cat.slug,
            count: rawPosts.filter(p => toSlug(p.category) === cat.slug).length
        }));
    ...
    const filteredPosts = useMemo(() => {
        ...
        return rawPosts.filter(post => {
            ...
            // Category filter
            const matchesCategory = selectedCategory === "all" || toSlug(post.category) === selectedCategory;
