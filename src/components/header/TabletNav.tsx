...
const TabletNav = () => {
  ...
  return (
    <div className="hidden md:flex lg:hidden items-center space-x-1">
      ...
      <Link to="/treinamento" className={cn("px-2 py-1.5 rounded-md text-sm font-medium transition-colors", isActive('/treinamento') ? 'text-blue-900 bg-blue-900/10' : 'text-gray-700 hover:text-blue-900')}>Treinamento</Link>
      <Link to="/contacto">
