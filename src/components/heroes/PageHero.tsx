...
const PageHero: React.FC<PageHeroProps> = ({
  ...
  return <section className={`pt-20 pb-12 relative overflow-hidden ${className}`}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center my-[100px]">
          {subtitle && <div className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold mb-4 ${backgroundImage ? 'bg-white/10 text-white border border-white/20 backdrop-blur-sm' : 'bg-gradient-to-r from-brand-blue-100 to-brand-orange-100 text-brand-blue'}`}>
              {subtitle}
            </div>}
          ...
          {(ctaText || onCtaClick) && <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
