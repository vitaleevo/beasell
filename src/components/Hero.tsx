...
const Hero = () => {
  return (
    <section id="inicio" className="pt-16 pb-8 bg-gradient-to-br from-blue-50 via-white to-orange-50 overflow-hidden relative">
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[65vh]">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center bg-white/80 backdrop-blur-sm p-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link to="/servicos">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white px-6 py-3 text-base shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto"
                >
                  Ver Formações
              ...
              <Link to="/sobre">
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white px-6 py-3 text-base shadow-xl hover:shadow-orange-500/25 transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto"
                >
          ...
          <div className="relative animate-fade-in">
            ...
            <div className="absolute -top-3 -right-3 bg-gradient-to-br from-orange-500 to-orange-600 text-white p-3 rounded-xl shadow-2xl animate-pulse">
              <Users className="h-5 w-5 mb-1" />
              <div className="text-xs font-bold">Alta</div>
              <div className="text-xs opacity-90">Performance</div>
            </div>
            
            <div className="absolute -bottom-3 -left-3 bg-gradient-to-br from-blue-900 to-blue-800 text-white p-3 rounded-xl shadow-2xl animate-pulse">
              <Trophy className="h-5 w-5 mb-1" />
              <div className="text-xs font-bold">Resultados</div>
              <div className="text-xs opacity-90">Comprovados</div>
            </div>

            <div className="absolute top-1/2 -left-2 bg-gradient-to-br from-green-500 to-green-600 text-white p-2 rounded-lg shadow-xl animate-pulse">
