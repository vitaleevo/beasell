    ...
    <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
      ...
      <div className="space-y-4 sm:space-y-5 lg:space-y-6 order-1 lg:order-2 px-2 sm:px-0">
        ...
        <div className="space-y-3 sm:space-y-4">
          <div className="flex items-start p-3 sm:p-4 bg-white rounded-lg shadow-sm border border-gray-100">
            <div className="bg-orange-100 p-2 sm:p-2.5 rounded-lg mr-3 sm:mr-4 flex-shrink-0">
              <MapPin className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-orange-600" />
            </div>
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed">
                Formações no nosso centro em Luanda ou nas suas instalações
              </p>
            </div>
          </div>
          
          <div className="flex items-start p-3 sm:p-4 bg-white rounded-lg shadow-sm border border-gray-100">
            <div className="bg-blue-100 p-2 sm:p-2.5 rounded-lg mr-3 sm:mr-4 flex-shrink-0">
              <HeadphonesIcon className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600" />
            </div>
            <div className="flex-1 min-w-0">
              <h4 className="font-semibold text-gray-900 text-sm sm:text-base lg:text-lg mb-1">
                Online
              ...
              <p className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed">
                Sessões virtuais interactivas com a mesma qualidade
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start p-3 sm:p-4 bg-white rounded-lg shadow-sm border border-gray-100">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed">
                Formações customizadas na sua empresa
              </p>
            </div>
          </div>
        </div>
