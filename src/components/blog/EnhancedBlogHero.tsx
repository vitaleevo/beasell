...
const EnhancedBlogHero = () => {
  const { getFeaturedPosts } = useBlogActions();
  ...
  return (
    <section className="pt-24 pb-16 bg-gradient-to-br from-blue-900 via-blue-800 to-orange-600 relative overflow-hidden">
      {/* Background Pattern */}
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/blog/categorias">
              <Button 
                size="lg" 
                variant="outline" 
                className="border-white text-white hover:bg-white hover:text-blue-900 bg-white/10 backdrop-blur-sm"
              >
