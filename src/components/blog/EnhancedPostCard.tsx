...
const EnhancedPostCard = ({ 
  ...
  return (
    <Card className={`group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 overflow-hidden bg-white ${
      isFeatured ? 'ring-2 ring-orange-200 shadow-lg' : 'shadow-md'
    }`}>
      {/* Image Section */}
      {!isCompact && (
      ...
      {!isLarge && (
        <div className="p-6">
          ...
          {/* Title */}
          <h3 className={`font-bold leading-tight mb-3 group-hover:text-blue-900 transition-colors ${
